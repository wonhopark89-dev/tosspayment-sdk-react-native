...
var _PaymentsWebView = require("../webview/PaymentsWebView");
function AgreementWidget(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_reactNative.View, {
  ...
  }, /*#__PURE__*/React.createElement(_PaymentsWebView.PaymentsWebView, {
    ...
    onLoadEnd: onLoadEnd,
    onMessage: event => {
      var _mainWidget$current, _mainWidget$current$f, _webview$current;
      ...
      switch (jsonObject.name) {
        ...
        case 'widgetStatus':
          break;
        case 'error':
          mainWidget === null || mainWidget === void 0 || (_mainWidget$current = mainWidget.current) === null || _mainWidget$current === void 0 || (_mainWidget$current$f = _mainWidget$current.fail) === null || _mainWidget$current$f === void 0 || _mainWidget$current$f.call(_mainWidget$current, {
          ...
          break;
        default:
          (_webview$current = webview.current) === null || _webview$current === void 0 || _webview$current.onMessage(event);
          break;
      }
    },
    containerStyle: {
