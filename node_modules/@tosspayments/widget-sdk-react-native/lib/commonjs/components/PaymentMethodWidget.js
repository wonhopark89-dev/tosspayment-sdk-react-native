...
exports.PaymentMethodWidget = PaymentMethodWidget;
...
var _RequestPaymentsModal = require("./RequestPaymentsModal");
function PaymentMethodWidget(_ref) {
  ...
  const [requestPaymentHTML, setRequestPaymentHTML] = (0, _react.useState)(null);
  (0, _react.useEffect)(() => {
  ...
  }, /*#__PURE__*/React.createElement(_RequestPaymentsModal.RequestPaymentsModal, {
